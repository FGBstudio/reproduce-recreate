...
const translations: Record<ReportLanguage, ReportTranslations> = {
  en: {
    ...
    kpis: { temperature: "Temperature", co2: "CO2", humidity: "Humidity", airQuality: "Air Quality" },
    ...
    energy: { consumptionChart: "Energy Consumption Chart", consumption: "Energy Consumption", deviceChart: "Device Consumption Chart", deviceConsumption: "Consumption by Device", co2Emissions: "CO2 Emissions" },
    ...
    airQuality: { chart: "Air Quality Chart", co2TvocHistory: "CO2 and TVOC History", tempHumidity: "Temperature and Humidity", particulates: "Particulates (PM2.5 / PM10)" },
    tables: { device: "Device", consumptionKwh: "Consumption (kWh)", category: "Category", zone: "Zone", leakRate: "Leak Rate (L/h)", status: "Status", detected: "Detected", co2Kg: "CO2 (kg)", consumptionL: "Consumption (L)" },
  ...
  it: {
    ...
    kpis: { temperature: "Temperatura", co2: "CO2", humidity: "Umidità", airQuality: "Qualità Aria" },
    ...
    energy: { consumptionChart: "Grafico Consumi Energetici", consumption: "Consumi Energetici", deviceChart: "Grafico Consumi per Dispositivo", deviceConsumption: "Consumi per Dispositivo", co2Emissions: "Emissioni CO2" },
    ...
    airQuality: { chart: "Grafico Qualità Aria", co2TvocHistory: "Storico CO2 e TVOC", tempHumidity: "Temperatura e Umidità", particulates: "Particolato (PM2.5 / PM10)" },
    tables: { device: "Dispositivo", consumptionKwh: "Consumo (kWh)", category: "Categoria", zone: "Zona", leakRate: "Tasso Perdita (L/h)", status: "Stato", detected: "Rilevato", co2Kg: "CO2 (kg)", consumptionL: "Consumo (L)" },
  ...
  fr: {
    ...
    kpis: { temperature: "Température", co2: "CO2", humidity: "Humidité", airQuality: "Qualité de l'air" },
    ...
    energy: { consumptionChart: "Graphique de consommation énergétique", consumption: "Consommation énergétique", deviceChart: "Graphique de consommation par appareil", deviceConsumption: "Consommation par appareil", co2Emissions: "Émissions de CO2" },
    ...
    airQuality: { chart: "Graphique qualité de l'air", co2TvocHistory: "Historique CO2 et TVOC", tempHumidity: "Température et Humidité", particulates: "Particules (PM2.5 / PM10)" },
    tables: { device: "Appareil", consumptionKwh: "Consommation (kWh)", category: "Catégorie", zone: "Zone", leakRate: "Taux de fuite (L/h)", status: "Statut", detected: "Détecté", co2Kg: "CO2 (kg)", consumptionL: "Consommation (L)" },
  ...
  es: {
    ...
    kpis: { temperature: "Temperatura", co2: "CO2", humidity: "Humedad", airQuality: "Calidad del aire" },
    ...
    energy: { consumptionChart: "Gráfico de consumo energético", consumption: "Consumo energético", deviceChart: "Gráfico de consumo por dispositivo", deviceConsumption: "Consumo por dispositivo", co2Emissions: "Emisiones de CO2" },
    ...
    airQuality: { chart: "Gráfico de calidad del aire", co2TvocHistory: "Historial de CO2 y TVOC", tempHumidity: "Temperatura y Humedad", particulates: "Partículas (PM2.5 / PM10)" },
    tables: { device: "Dispositivo", consumptionKwh: "Consumo (kWh)", category: "Categoría", zone: "Zona", leakRate: "Tasa de fuga (L/h)", status: "Estado", detected: "Detectado", co2Kg: "CO2 (kg)", consumptionL: "Consumo (L)" },
  ...
  zh: {
    ...
    kpis: { temperature: "温度", co2: "CO2", humidity: "湿度", airQuality: "空气质量" },
    sections: { energyDashboard: "📊 能源仪表板", waterDashboard: "💧 水务仪表板", airQualityDashboard: "🌬️ 空气质量仪表板", aiDiagnosis: "性能诊断" },
    energy: { consumptionChart: "能耗图表", consumption: "能耗", deviceChart: "设备能耗图表", deviceConsumption: "按设备能耗", co2Emissions: "CO2 排放" },
    water: { consumptionChart: "用水量图表", consumption: "用水量", quality: "水质", leakDetection: "漏水检测" },
    airQuality: { chart: "空气质量图表", co2TvocHistory: "CO2 与 TVOC 历史", tempHumidity: "温度与湿度", particulates: "颗粒物 (PM2.5 / PM10)" },
    tables: { device: "设备", consumptionKwh: "能耗 (kWh)", category: "类别", zone: "区域", leakRate: "泄漏率 (L/h)", status: "状态", detected: "检测时间", co2Kg: "CO2 (kg)", consumptionL: "消耗量 (L)" },

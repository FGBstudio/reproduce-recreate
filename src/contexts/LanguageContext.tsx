...
const translations: Record<string, Record<Language, string>> = {
  ...
  'brand.energy_tooltip': { en: "Total energy over 30 days, 'general' category meters only.", it: "Consumo totale ultimi 30 giorni, solo contatori 'general'.", fr: "Énergie totale sur 30 jours, compteurs catégorie 'general' uniquement.", es: "Energía total en 30 días, solo contadores categoría 'general'.", zh: "30天总能耗，仅限"general"类别计量器。" },

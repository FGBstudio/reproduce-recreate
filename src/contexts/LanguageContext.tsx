...
const translations: Record<string, Record<Language, string>> = {
  ...
  'overview.aqi_title': { en: 'Air Quality Index', it: 'Indice Qualità Aria', fr: "Indice de qualité de l'air", es: 'Índice de calidad del aire', zh: '空气质量指数' },
  'overview.aqi_band_very_good': { en: 'Very Good', it: 'Ottima', fr: 'Très bon', es: 'Muy buena', zh: '非常好' },
  'overview.aqi_band_good': { en: 'Good', it: 'Buona', fr: 'Bon', es: 'Buena', zh: '良好' },
  'overview.aqi_band_ok': { en: 'OK', it: 'Discreta', fr: 'Correct', es: 'Aceptable', zh: '一般' },
  'overview.aqi_band_critical': { en: 'Critical', it: 'Critica', fr: 'Critique', es: 'Crítica', zh: '严重' },
 ...
 'time.ytd': { en: 'Year to date', it: 'Anno corrente', fr: 'Année en cours', es: 'Año actual', zh: '本年至今' },
  ...
  'auth.new_password_title': { en: 'Set a new password', it: 'Imposta una nuova password', fr: 'Définir un nouveau mot de passe', es: 'Establecer nueva contraseña', zh: '设置新密码' },
  'auth.new_password_subtitle': { en: 'Choose your new password below.', it: 'Scegli qui sotto la tua nuova password.', fr: 'Choisissez votre nouveau mot de passe ci-dessous.', es: 'Elige tu nueva contraseña a continuación.', zh: '请在下方设置您的新密码。' },
  'auth.new_password': { en: 'New password', it: 'Nuova password', fr: 'Nouveau mot de passe', es: 'Nueva contraseña', zh: '新密码' },
  'auth.save_new_password': { en: 'Save new password', it: 'Salva la nuova password', fr: 'Enregistrer le nouveau mot de passe', es: 'Guardar nueva contraseña', zh: '保存新密码' },
  'auth.passwords_do_not_match': { en: 'Passwords do not match.', it: 'Le password non coincidono.', fr: 'Les mots de passe ne correspondent pas.', es: 'Las contraseñas no coinciden.', zh: '两次输入的密码不一致。' },
  'auth.password_min_length': { en: 'Password must be at least 6 characters.', it: 'La password deve contenere almeno 6 caratteri.', fr: 'Le mot de passe doit contenir au moins 6 caractères.', es: 'La contraseña debe tener al menos 6 caracteres.', zh: '密码至少需要 6 个字符。' },
  'auth.password_updated': { en: 'Password updated. Redirecting…', it: 'Password aggiornata. Reindirizzamento…', fr: 'Mot de passe mis à jour. Redirection…', es: 'Contraseña actualizada. Redirigiendo…', zh: '密码已更新，正在跳转…' },
  'auth.password_update_error': { en: 'Could not update the password.', it: 'Impossibile aggiornare la password.', fr: 'Impossible de mettre à jour le mot de passe.', es: 'No se pudo actualizar la contraseña.', zh: '无法更新密码。' },
  'auth.not_configured': { en: 'Authentication is not configured in this environment.', it: 'L’autenticazione non è configurata in questo ambiente.', fr: 'L’authentification n’est pas configurée dans cet environnement.', es: 'La autenticación no está configurada en este entorno.', zh: '此环境未配置身份验证。' },

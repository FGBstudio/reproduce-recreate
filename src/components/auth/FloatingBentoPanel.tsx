...
const FloatingBentoPanel: React.FC = () => {
  ...
  const logoTop = useTransform(scrollY, [0, 400], ["350%", "24px"]);
  ...
  const logoRightTop = useTransform(scrollY, [0, 400], ["350%", "240px"]);
  const logoRightRight = useTransform(scrollY, [0, 400], ["220%", "160px"]);
